...
list_user *return_book(unsigned int id, const char *username, list_single *head, list_user *uhead){              //Return a book
int alr;
int i;
int choice;
int k = 0;
                                    ...
                                    for(i=0;i<3;++i){
                                        if(fur->idar[i]==id)
                                        {
                                            if(i==0){
                                                ...
                                                fur->idar[2] = 0;
                                                printf("Return complete. Now book 1 is %d, book2 is %d, book3 is %d",fur->idar[0],fur->idar[1],fur->idar[2]);
                                                cur->data.copies = cur->data.copies+1;
                                                return 0;
